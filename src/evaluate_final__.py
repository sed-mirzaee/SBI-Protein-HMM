"""Final lightweight evaluation___ pipeline.
...
from src.evaluation.metrics__ import (
    posterior_mse,
...
DEFAULT_RESULTS_PATH = Path("outputs/evaluation___/final_results.json")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run final project evaluation___.")
...
def main() -> None:
    ...
    # HMM-only evaluation___ does not require Sara's trained model.
    if args.hmm_only:
        ...
        print("\nHMM real-protein evaluation___")
        print("---------------------------")
        print(
        ...
        output_path = Path(
            "outputs/evaluation___/hmm_real_results.json"
        )
    ...
    # Full evaluation___ starts here
